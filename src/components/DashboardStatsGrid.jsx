...
export default function DashboardStatsGrid() {
	...
	const TotalSales = localStorage.getItem('alltotalRevenue');
	const data = JSON.parse(localStorage.getItem('bookingIds')) || []
	// tính tổng số lượng ở trong bookingIds
	...
	return (
		<div className="flex gap-4">
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">{TotalSales} VND</strong>
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Tổng Số Lượng Vé Đã Đặt</span>
					<div className="flex items-center">
